...
const config = {
  "generator": {
    ...
    "output": {
      "value": "C:\\Users\\usuario\\OneDrive\\Escritorio\\Hotel_Facturación\\vite-project\\backend\\generated\\prisma",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "C:\\Users\\usuario\\OneDrive\\Escritorio\\Hotel_Facturación\\vite-project\\backend\\prisma\\schema.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": "../../.env",
  ...
  "inlineDatasources": {
    "db": {
      "url": {
        "fromEnvVar": "DATABASE_DEPLOY_URL",
        "value": null
      }
    }
  },
...
config.injectableEdgeEnv = () => ({
  parsed: {
    DATABASE_DEPLOY_URL: typeof globalThis !== 'undefined' && globalThis['DATABASE_DEPLOY_URL'] || typeof process !== 'undefined' && process.env && process.env.DATABASE_DEPLOY_URL || undefined
  }
})
