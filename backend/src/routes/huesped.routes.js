...
const { getAllHuespedes, getHuespedesFrecuentes, getHuesped, getHuespedDocumento, postHuesped, deleteHuesped, putHuesped, patchHuesped } = huespedController;
...
router.get('/buscar/:dato', authenticate, getHuespedDocumento);
